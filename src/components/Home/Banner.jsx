...
const Banner = () => {
  ...
  return (
    <section className="banner relative w-full h-[480px] sm:h-[520px] md:h-[600px] lg:h-[700px] xl:h-[800px] mb-16">
      ...
      <button 
        ...
        className="absolute left-2 top-1/2 transform -translate-y-1/2 btn btn-circle btn-ghost z-10"
      >
        <ChevronLeft className="w-6 h-6 text-white" />
      </button>
      <button 
        onClick={handleNextSlide}
        className="absolute right-2 top-1/2 transform -translate-y-1/2 btn btn-circle btn-ghost z-10"
      >
