...
export default function TeachForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-2xl shadow-2xl space-y-6">
      {/* User Information Section */}
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-6 rounded-xl flex items-center justify-between">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Button
          type="submit"
          className="w-full btn  transition-colors text-lg font-semibold"
